...
enum Icon {
    static var offline: Image { Image(systemName: "icloud.slash") }
    static var syncing: Image { Image(systemName: "arrow.clockwise") }
    ...
    static var chevronLeft: Image { Image(systemName: "chevron.left") }
    static var chevronRight: Image { Image(systemName: "chevron.right") }
    static var laptop: Image { Image(systemName: "laptopcomputer") }
    static var phone: Image { Image(systemName: "iphone") }
    static var clock: Image { Image(systemName: "clock") }
    static var checkmarkCircle: Image { Image(systemName: "checkmark.circle") }
    static var listBullet: Image { Image(systemName: "list.bullet") }
