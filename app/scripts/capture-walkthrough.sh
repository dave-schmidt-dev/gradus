...
ROUTES=(
  ...
  "settings.close-result|settings-close-result|explore-sample|settings-close-result.png"
  ...
  "settings.card-size-result|settings-card-size-result|Card size|settings-card-size-result.png"
  "settings.hide-exhausted-result|settings-hide-exhausted-result|show-exhausted-toggle|settings-hide-exhausted-result.png"
  "settings.explore-progress|settings-explore-progress|explore-sample-settings|settings-explore-progress.png"
  "settings.explore-result|settings-explore-result|sample-data-banner|settings-explore-result.png"
